...
const trustItems = [
  { title: "Офіційна якість", text: "100% натуральний шовк, добірна сировина" },
  { title: "Швидка доставка", text: "Відправка по Україні та Європі. Дбайливе й надійне пакування кожного замовлення" },
  { title: "Дбайлива підтримка", text: "Допоможемо з вибором та розміром" },
];
