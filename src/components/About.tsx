        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-background/80 leading-relaxed">
              <p>
                Black Collection від Silk4me — це добірка виробів із натурального шовку mulberry 6A, створених для щоденного комфорту та відчуття якості в деталях.
                Матеріал приємний до тіла, добре зберігає форму та вигляд навіть після багаторазового використання.  
              </p>
              <p>
